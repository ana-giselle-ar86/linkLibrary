...
*	الآن في أي قائمة، إذا كنت تقف على رابط أو مكتبة أو مكتبة فرعية، يمكنك إزالة العنصر باستخدام مفتاح الحذف أو حذف مِن اللوحة الرقمية.

### التغييرات في 2.3 ###

*	إضافة ميزة التنقّل باستخدام حرفين في صناديق القوائم (ListBoxes)، بحيث يمكن للمستخدم الآن التنقّل باستخدام حرفين متتاليين في مربعات حوار المكتبة والروابط، مع إمكانية الدوران بين العناصر كما في مستكشف الملفات.

### التغييرات في 2.2.9 ###

*	إصلاح الخلل في زر "إظهار قيمة الرابط" في مربع حوار الروابط، والذي ظهر بلغات أخرى غير الإنجليزية.
*	إضافة الترجمة إلى اللغة الإسبانية، بمساهمة مِن [Ana Giselle](https://github.com/ana-giselle-ar86).

### التغييرات في 2.2.7 ###

*	إضافة الترجمة إلى اللغة الإسبانية، بمساهمة مِن [آنا جيزيل](https://github.com/ana-giselle-ar86).

### التغييرات في 2.2.6 ###

*	لقد تم تحديث آخر إصدار تم اختباره ليتوافق مع إصدار NVDA الأخير 2026.1.
*	في مربع إعدادات الإضافة، في صندوق الاختيار الذي يحتوي على عدة مسارات لتخزين بيانات الإضافة، أصبح الآن يتم عرض المسار الكامل للمجلد وليس تسمية المسار فقط.

### التغييرات في 2.2.5 ###

*	تحديث الترجمة إلى اللغة الأوكرانية، بمساهمة مِن [@George-br](https://github.com/George-br).
