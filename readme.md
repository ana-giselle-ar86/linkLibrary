...
*	Tip: While standing on a link, library, or sub library you can press Delete or Numpad Delete to remove the selected item.  
...
*	Now in any listBox, if standing on a link, library, or sub library, you can remove the item with the delete or numpad delete key.
...
*	Update last tested version, to comply with recent NVDA release 2026.1.
*	In the addon settings dialog, in the combo box that contains several paths to store addon data, now the whole directory path is displayed and not path label only.

### Changes for 2.2.5 ###

*	Update the Ukrainian translation, contributed by [@George-br](https://github.com/George-br).
